    ...
    <>
        <div className="px-6 md:px-32 relative mt-[90px] flex flex-col justify-center items-center -z-[111]">
            <div className="pt-12 px-12 text-[#111D5E] text-[48px] lg:text-[100px] xl:text-[140px] text-center font-bold lg:leading-[140px] bg-[url('/heroTop.svg')] bg-no-repeat">
                React <br/>
                <span className='-ml-[130px] lg:-ml-[270px] xl:-ml-[400px]'>Conference</span>
            </div>
            <img className='absolute -z-50 top-[6%] left-[25%] lg:left-[38%] xl:left-[45%]' src="/dotline.svg"/>
            ...
            <div className='px-6 py-4 rounded-full md:-ml-[230px] my-4 flex justify-center items-center bg-[#FFC93E] w-[290px]'>
                Buy Tickets <Image className="ml-2" src="./arrow.svg" height={14} width={14} alt="image"/>
            </div>
        </div>
        ...
        <div className='hidden lg:flex justify-center -rotate-90 pl-32 cursor-pointer' onClick={scrollToTimeline}>
            <Image className="mr-4 rotate-90" src="./Ornament.svg" height={12} width={12} alt="ornament"/>
            Scroll Down 
        </div>
    </>
  )
